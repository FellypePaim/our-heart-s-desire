...
export function AppSidebar() {
  ...
  const resellerItems = [
    ...
    { to: "/billing", label: "Cobranças", icon: Zap },
    ...
    <>
      ...
      <div className="border-t border-sidebar-border p-3 pb-[env(safe-area-inset-bottom,8px)] space-y-2" style={{ paddingBottom: 'max(env(safe-area-inset-bottom, 8px), 1rem)' }}>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={toggleTheme}
            className="flex flex-1 items-center gap-3 rounded-lg px-3 py-2 text-sm text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-primary transition-colors"
          >
